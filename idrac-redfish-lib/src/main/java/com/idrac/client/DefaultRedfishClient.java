...
public class DefaultRedfishClient implements RedfishClient {
    ...
    public String triggerExport(ExportTarget target, ExportFormat exportFormat, ExportUse exportUse, IncludeInExport... includes) {
        try {
            ...
            String includeInExport = String.join(",",
            ...
            Response response =
                    feignApi.triggerExport(request);
            ...
            if (location == null || location.isEmpty()) {
                ...
                throw new RuntimeException(
                        "No job Location returned in response."
                );
            }
    ...
    public void pollJob(String jobId, long timeoutMillis)
        ...
        while (System.currentTimeMillis() < deadline) {
            ...
            try {
                ...
                String messageShort =
                        message != null && message.length() > 60
                ...
                System.out.printf(
                        ...
                        state,
                        percentStr,
                        messageShort != null ? messageShort : ""
                );
    ...
    public String fetchScp(String jobId, ExportFormat exportFormat) {
        ...
        try {
            ...
            System.out.println(
                    "[*] Fetching SCP content from TaskService ..."
            );

            Response response =
                    feignApi.getTask(jobId);
            ...
            if (exportFormat == ExportFormat.XML) {
                ...
                if (!content.contains("<SystemConfiguration")) {
                    ...
                    throw new RuntimeException(
                            "Response doesn't look like SCP XML."
                    );
                }
            }
            ...
            // ---------------------------------------------------
                ...
                if (parsed.has("SystemConfiguration")
                        || parsed.has("Components")) {
                    ...
                    throw new RuntimeException(
                            "Response doesn't look like SCP JSON."
                    );
                }
            }
